...
namespace Engine
{
    ...
    CComPtr<ID3D11SamplerState> DirectX11States::GetSamplerState(ESamplerState ss)
    {
    ...
    CComPtr<ID3D11BlendState> DirectX11States::GetBlendState(EBlendState bs)
    {
    ...
    CComPtr<ID3D11RasterizerState> DirectX11States::GetRasterizerState(ERasterizerState rs)
    {
    ...
    CComPtr<ID3D11DepthStencilState> DirectX11States::GetDepthStencilState(EDepthStencilState dss)
    {
