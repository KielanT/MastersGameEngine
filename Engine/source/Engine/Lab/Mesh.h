...
namespace Engine
{
    ...
    public:
        ...
        glm::mat4 GetNodeDefaultMatrix(unsigned int node) { return mNodes[node].defaultMatrix; }
    ...
    private:
        ...
        struct Node
        {
            ...
            glm::mat4   defaultMatrix; // Starting position/rotation/scale for this node. Relative to parent. Used when first creating a model from this mesh
    ...
    private:
        ...
        void ConvertMatrices(glm::mat4& gM, aiMatrix4x4& aM);
